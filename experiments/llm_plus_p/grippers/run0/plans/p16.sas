...
Atom carry(robot1, ball7, left)
Atom carry(robot1, ball8, left)
...
Atom carry(robot1, ball7, right)
Atom carry(robot1, ball8, right)
...
Atom carry(robot2, ball7, left)
Atom carry(robot2, ball8, left)
...
Atom carry(robot2, ball7, right)
Atom carry(robot2, ball8, right)
...
Atom carry(robot3, ball7, left)
Atom carry(robot3, ball8, left)
...
Atom carry(robot3, ball7, right)
Atom carry(robot3, ball8, right)
...
Atom carry(robot4, ball7, left)
Atom carry(robot4, ball8, left)
...
Atom carry(robot4, ball7, right)
Atom carry(robot4, ball8, right)
